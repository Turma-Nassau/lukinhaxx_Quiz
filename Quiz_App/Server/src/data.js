const data =[
   ...
   "questoes":[
      ...
      {
         "numQuestao":1,
         "pergunta":"Setentrional e Meridional são sinônimos de...",
         "alternativaA":"Leste e Oeste",
         "alternativaB":"Norte e Sul",
         "alternativaC":"Ocidental e Oriental",
         "alternativaD":"Nordeste e Noroeste",
         "correta":"Norte e Sul"
      },
      {
         "numQuestao":2,
      ...
      {
         "numQuestao":12,
         "pergunta":"A população estimada do Brasil em 2021 é de...",
         "alternativaA":"190 milhões de hab.",
         "alternativaB":"400 milhões de hab.",
         "alternativaC":"1 bilhão de hab.",
         "alternativaD":"211 milhões de hab.",
         "correta":"211 milhões de hab."
      }
   ]
}
];
